...
if(Word_printing=="ON")
 WordFile=sprintf("C:/Users/Joni-/LUT/DITYO2/RAAKAANAL/Trend%sdic%s_%s.doc",ver,f,daf)
...
#if(Word_printing=="ON")
# WordFile=sprintf("RAAKAANAL/Topic%sdic%s_%s.doc",ver,f,daf)

if(Pdf_printing=="ON")
 PdfFile=sprintf("RAAKAANAL/Trendv%svdic%s_%s.pdf",ver,daf,f)
 
if(Table_printing=="ON")
